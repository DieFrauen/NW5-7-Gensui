...
function c97057006.drop(e,tp,eg,ep,ev,re,r,rp)
	...
	local hc=Duel.GetFieldGroupCount(p,0,LOCATION_HAND)
	local fc=Duel.GetMatchingGroupCount(c97057006.filter,p,LOCATION_MZONE,0,nil)
	local ct=math.min(hc,fc)-Duel.GetFieldGroupCount(p,LOCATION_HAND,0)
